...
import { DisplayFilteredTS } from './DisplayFilteredTS';
...
export function MakeRecipeTS({
    ...
    handleRemoveNote}: MakeRecipeProps) {
     ...
     console.log("MAKE RECIPE TSX RENDERING")
    ...
    useEffect(() => {
        ...
        console.log("make recipe updated: ", JSON.stringify(makeRecipe) )
        console.log("make recipe length: ", makeRecipe.length)

    }, [filteredRecipe, notesList, makeRecipe]);
